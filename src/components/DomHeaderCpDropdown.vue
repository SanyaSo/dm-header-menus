<template>
  <div class="dom-header-cp-dropdown">
    <a @mouseenter="visible = true" class="dom-header-cp-dropdown__triger" href="https://dom.kz/cp">{{ userName }}</a>
    <div @mouseleave="visible = false" v-if="visible" class="dom-header-cp-dropdown__body">
        <a class="dom-header-cp-dropdown__item" v-for="item in dropDownOptions" :key="item.id" :href="item.href">
